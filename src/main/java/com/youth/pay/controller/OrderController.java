package com.youth.pay.controller;
...
import com.youth.pay.util.AlipayProperties;
...
public class OrderController {
    ...
    public void pay(BigDecimal orderAmount, HttpServletResponse httpResponse) throws Exception {
        String payResult = userOrderService.orderPay(orderAmount);
    ...
    public String notifyPayResult(HttpServletRequest request) {
        ...
        try {
            ...
            signVerified = AlipaySignature
                .rsaCheckV1(params, alipayProperties.getPublicKey(), alipayProperties.getCharset(), alipayProperties.getSignType());
        ...
        if (signVerified) {
            ...
            if ("TRADE_FINISHED".equals(tradeStatus) || "TRADE_SUCCESS".equals(tradeStatus)) {
                //根据订单号查找订单,防止多次回调的问题
                UserOrder orderByOrder = userOrderService.getOrderByOrderNo(outTradeNo);
                if (orderByOrder != null && orderByOrder.getOrderStatus() == OrderEnum.ORDER_STATUS_NOT_PAY.getStatus()) {
                    ...
                    userOrderService.updateOrder(orderByOrder);
                }
                return "success";
            } else {
                return "failure";
